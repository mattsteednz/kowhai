...
void setupLocator() {
  locator.registerLazySingleton<PositionService>(() => PositionService(
        onPositionSaved: () {
          locator<PositionBackupService>().scheduleExport();
          locator<PositionBackupService>().scheduleUpload();
        },
      ));
  ...
  locator.registerLazySingleton<PositionBackupService>(() => PositionBackupService());
